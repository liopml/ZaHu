...
public interface GoldApis {
    ...
    /**
     * 热门推荐
     * https://api.leancloud.cn/1.1/classes/Entry?include=user,user.installation
     * &where={"category":"android","createdAt":{"$gt":{"__type":"Date","iso":"2016-11-25T16:04:44.024Z"}},"objectId":{"$nin":["58362f160ce463005890753e","583659fcc59e0d005775cc8c","5836b7358ac2470065d3df62"]}}
     * &order=-hotIndex
     * &limit=3
     */
    @GET("1.1/classes/Entry")

...
public class NewsChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<NewsChannelTableBean> mMyChannelItems, mOtherChannelItems;

    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;

    public NewsChannelAdapter(Context context, ItemTouchHelper helper, List<NewsChannelTableBean> mMyChannelItems, List<NewsChannelTableBean> mOtherChannelItems) {
    ...
    public int getItemViewType(int position) {
        ...
        } else if (position > 0 && position < mMyChannelItems.size() + 1) {  //我的频道
            return TYPE_MY;
        } else {  //其他频道
            return TYPE_OTHER;
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof MyViewHolder) {
            ...
            myHolder.textView.setText(mMyChannelItems.get(position - COUNT_PRE_MY_HEADER).getNewsChannelName());
            if (isEditMode) {
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        NewsChannelTableBean item = mMyChannelItems.get(startPosition);
    ...
    private ImageView addMirrorView(ViewGroup parent, RecyclerView recyclerView, View view) {
        ...
        //获取currentView在整个屏幕内的绝对坐标，注意这个值是要从屏幕顶端算起，也就是包括了通知栏的高度。
        view.getLocationOnScreen(locations);
        int[] parenLocations = new int[2];
        //获取recyclerView在整个屏幕内的绝对坐标，注意这个值是要从屏幕顶端算起，也就是包括了通知栏的高度。
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        NewsChannelTableBean item = mOtherChannelItems.get(startPosition);
    ...
    class OtherViewHolder extends RecyclerView.ViewHolder {
        ...
        public OtherViewHolder(View itemView) {
            super(itemView);
            textView = (TextView) itemView.findViewById(R.id.tv_other);
        }
    }
